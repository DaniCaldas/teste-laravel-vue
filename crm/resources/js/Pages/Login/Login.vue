<template>
  <div class="min-h-screen bg-gray-50 flex items-center justify-center p-4">
    <div class="flex w-full max-w-6xl h-[600px] bg-white rounded-2xl shadow-2xl overflow-hidden">
      
      <!-- Seção do Formulário -->
      <div class="flex-1 flex flex-col justify-center px-12 py-16">
        <div class="max-w-md mx-auto w-full">
          ...
          <p class="text-gray-600 text-center mb-10 leading-relaxed">
            Visualize todos os seus colaboradores com performance e segurança
          </p>
          ...
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                v-model="form.cnpj"
                @input="applyCnpjMask"
                class="w-full px-5 py-4 bg-gray-50 border-2 border-gray-200 rounded-xl text-gray-800 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:bg-white focus:ring-3 focus:ring-blue-100 transition-all duration-300"
                placeholder="00.000.000/0000-00"
                maxlength="18"
                required
                :class="{ 'border-red-300 focus:border-red-500': form.errors.cnpj }"
              />
              <div v-if="form.errors.cnpj" class="text-red-500 text-sm mt-2">
                {{ form.errors.cnpj }}
              </div>
            </div>
          ...
          <div class="text-center mt-8">
            <p class="text-gray-600 text-sm mb-4">Não tem login?</p>
            <Link 
              href="/register" 
        ...
        <div class="max-w-sm mx-auto w-full">
          ...
          <form @submit.prevent="submit" class="space-y-4">
            ...
            <button
              type="submit"
              :disabled="form.processing"
              class="w-full py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-lg transition-all duration-300 disabled:opacity-50"
            >
          ...
          <div class="text-center mt-6">
            <p class="text-gray-600 text-sm mb-3">Não tem login?</p>
            <Link 
              href="/register"
